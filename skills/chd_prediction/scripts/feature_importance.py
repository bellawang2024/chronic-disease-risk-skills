...
def load_importance():
    ...
    model_path = os.path.join(MODELS_DIR, "chd_xgb_model.json")
...
def main():
    parser = argparse.ArgumentParser(description="查看冠心病模型特征重要性")
    ...
    print("=" * 78)
    print("说明: 医生告知的高血压/高胆固醇、自评健康状况排名靠前，除真实的病理关联外，")
    ...
    if args.plot:
        ...
        ax.set_title("Coronary Heart Disease - Feature Importance (XGBoost)")
